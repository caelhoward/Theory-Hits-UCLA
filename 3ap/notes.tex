...
We are trying to map vectors to integers such that adding the integers corresponds to adding the vectors. To do this, we map the integers to base $2k+1$ representations of their numbers of length $d$. More formally we have:
$$x = (x_1,x_2,..., x_d)$$
